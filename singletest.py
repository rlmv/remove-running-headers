...
for HTid in HTids_to_process:
    ...
    with open(textfilepath + postfix + ".meta",mode='w',encoding='utf-8') as file:
    ...
    with open(textfilepath + textfilename, mode='w', encoding='utf-8') as file:
